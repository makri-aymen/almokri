...
if(isset($_POST['comment'])){
  $thecomment=$_POST['comment'];
    @mysqli_query($db,"INSERT INTO `comments` (`id`, `comment`) VALUES ('$id','$thecomment')");
}
?>
<!DOCTYPE html>
<html lang="ar">
...
<meta charset="UTF-8">
        ...
        <title>ساق البامبو - المقرئ</title>
        <meta name="description" content="الكتاب الكامل تحميل الكتب احسن الكتب">
        <meta name=keywords" content="تحميل رواية ساق البامبو,ساق البامبو,رواية ساق البامبو">
        <meta name="author" content="سعود السنعوسي">
...
<div class="aboveanysection"><p class="upperpofallsection"><b>من مؤلفاته ايضا</b></p></div>
  ...
  <?php
    $ok=0;
     @$result =@mysqli_query($db,"SELECT * FROM all_books WHERE author='$author'");
     $row=@mysqli_fetch_assoc($result);
