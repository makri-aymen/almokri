...
@mysqli_set_charset($conn,"utf8");
 ...
 @$author=$row['author'];
 @$authorofthis=@mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `authors` WHERE id='$author'")); @$size=number_format(@filesize($pdflink) / 1048576 ,2) .' MB';
...
<title> المياه كلها بلون الغرق - المقرئ </title>
<meta charset="UTF-8">
<meta name="description" content="الكتاب الكامل تحميل الكتب احسن الكتب">
<meta name="keywords" content="تحميل كتاب المياه كلها بلون الغرق,المياه كلها بلون الغرق,المياه كلها بلون الغرق">
<meta name="author" content="إميل سيوران">
