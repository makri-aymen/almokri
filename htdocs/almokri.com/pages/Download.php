...
<img src="..\data\images_books\<?php echo $imglink ;?>" style="height:auto; width:50%; float:right; padding:5%;"></img>
...
<div style="width:80%; height:4px; border-radius:15px;margin-top:1%;background-color:rgba(8,182,152,0.6);" class="center"></div>
  <form method="post"  action="" type="hidden">
...
<button  style="cursor:pointer;margin-right:12px;float:right;background-color:#363636;padding:8px 8px 8px 8px;border-radius:15px;border:0px;overflow:hidden;"><a href="toreadthebook.php?id=<?php echo $id;?>" ><p class="fontsize"style="color:#08b698;"><b>قرائة</b></p></a></button>
...
<button style="cursor:pointer;float:right;background-color:#363636;padding:8px 8px 8px 8px;border-radius:15px;border:0px;"><p class="fontsize"style="color:#08b698;"><b>كتاب صوتي</b></p></button>
</div>
